...
(function () {
  ...
  function buildHero() {
    ...
    function pointerDown(event) {
      ...
      if (mount.parentElement) mount.parentElement.classList.add("dragging");
    ...
    function pointerUp() {
      ...
      if (mount.parentElement) mount.parentElement.classList.remove("dragging");
    }
    ...
    function loop() {
      ...
      residence.rotation.y = rotation;
      if (snowPoints && !reduce) snowPoints.rotation.y += 0.00045;
